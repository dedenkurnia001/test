            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <a class="btn btn-success" href="a_penjualan.php">Tambah Data</a>
                                ...
                                <div class="table-responsive">
                                    ...
                                    ?>
                                    <?php
                                      $a="select * from penjualan a, pelanggan b where a.id_pelanggan = b.id_pelanggan order by a.no_penjualan";
                                    ...
                                    ?>
                                            <tr>
                                                <td><?php echo $no;?></td>
                                                <td><?php echo $c['no_penjualan'];?></td>
                                                <td><?php echo $c['tgl_penjualan'];?></td>
                                                <td><?php echo $c['total_harga'];?></td>
                                                <td><?php echo $c['id_pelanggan'];?></td>
                                                <td><?php echo $c['nm_pelanggan'];?></td>
                                                <td><center><a class="btn btn-info btn-xs" href="dt_penjualan.php?no_penjualan=<?php echo $c['no_penjualan'];?>"><i class="fas fa-edit"></i></a></center>&nbsp;
                                                </td>
                                            </tr>
                                    <?php $no++; } ?>
                                        </tbody>
