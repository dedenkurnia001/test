...
$alamat=$_POST['alamat'];
    if (empty($id_pelanggan) or empty($nm_pelanggan) or empty($jenkel) or empty($no_telpon) or empty($alamat)){
      echo "<script language='javascript'>
alert('Data belum lengkap !');
</script>";
    }else{
    $a="update pelanggan set nm_pelanggan='$nm_pelanggan', jenkel='$jenkel', no_telpon='$no_telpon', alamat='$alamat' where id_pelanggan='$id_pelanggan'";
    $b=mysqli_query($koneksi,$a);
      if ($b) {
        echo "<script language='javascript'>
        alert('Pelanggan has been edited');
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Entry Data Pelanggan</h4>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Id Pelanggan</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="id_pelanggan" class="form-control" id="fname" placeholder="Id Pelanggan" value="<?php echo $data['id_pelanggan'];?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nama Pelanggan</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="nm_pelanggan" class="form-control" id="fname" placeholder="Nama Pelanggan" value="<?php echo $data['nm_pelanggan'];?>" onkeypress="return huruf(event)">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                ...
                                <div class="border-top">
                                    <div class="card-body">
                                        <input type="submit" name="simpan" class="btn btn-primary" value="Save">
                                         <a href="v_pelanggan.php" class="btn btn-danger">Cancel</a>
                                    </div>
                                </div>
                            </form>
                        </div>
