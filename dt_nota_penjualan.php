...
<?php
include "koneksi.php";
if(isset($_GET['kd_nota'])){
$kd_nota=$_GET['kd_nota'];
$sql="select * from nota_jual a, pelanggan b where a.kd_nota='$kd_nota' and a.id_pelanggan = b.id_pelanggan";
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Detail Cetak Nota Penjualan</h4>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Detail Data Cetak Nota Penjualan</h4>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Kode Nota Penjualan</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control"  placeholder="Kode Nota Penjualan" value="<?php echo $data['kd_nota'];?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Id Pelanggan</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" placeholder="Id Pelanggan" value="<?php echo $data['id_pelanggan'];?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nama Pelangan</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" placeholder="Nama Pelangan" value="<?php echo $data['nm_pelanggan'];?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Total Harga</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" value="<?php echo $data['jml_biaya'];?>" placeholder="Total Harga" readonly>
                                        </div>
                                    </div>
                                    ...
                                    ?>
                                    <?php
                                      $a="select * from dtl_penjualan a, sukucadang b where a.kd_sukucadang = b.kd_sukucadang and a.kd_nota = '$kd_nota' order by a.kd_sukucadang";
