...
$sql="select * from mekanik where id_mekanik='$id_mekanik'";
...
$nm_mekanik=$_POST['nm_mekanik'];
$jenkel=$_POST['jenkel'];
$no_telpon=$_POST['no_telpon'];
$alamat=$_POST['alamat'];
    if (empty($id_mekanik) or empty($nm_mekanik) or empty($jenkel) or empty($no_telpon) or empty($alamat)){
      echo "<script language='javascript'>
alert('Data belum lengkap !');
</script>";
    }else{
    $a="update mekanik set nm_mekanik='$nm_mekanik', jenkel='$jenkel', no_telpon='$no_telpon', alamat='$alamat' where id_mekanik='$id_mekanik'";
    $b=mysqli_query($koneksi,$a);
      if ($b) {
        echo "<script language='javascript'>
        alert('Mekanik has been edited');
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Edit Data Mekanik</h4>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Entry Data Mekanik</h4>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Id Mekanik</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="id_mekanik" class="form-control" id="fname" placeholder="Id Mekanik" value="<?php echo $data['id_mekanik'];?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nama Mekanik</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="nm_mekanik" class="form-control" id="fname" placeholder="Nama Mekanik" value="<?php echo $data['nm_mekanik'];?>" onkeypress="return huruf(event)">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Jenis Kelamin</label>
                                        <div class="col-sm-4">
                                            <input type="radio" name="jenkel" id="optionsRadios2" value="L" <?php if($data['jenkel']=='L'){echo "checked";}?>>
                                            Laki - laki &nbsp;
                                            <input type="radio" name="jenkel" id="optionsRadios2" value="P" <?php if($data['jenkel']=='P'){echo "checked";}?>>
                                            Perempuan
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" maxlength="13" name="no_telpon" value="<?php echo $data['no_telpon'];?>" class="form-control" id="fname" placeholder="No. Telpon" onkeypress="return isNumberKey(event)">
                                        </div>
                                    </div>
                                     <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Alamat</label>
                                        <div class="col-sm-9">
                                           <textarea rows="4" name="alamat" class="form-control no-resize" placeholder="Alamat"><?php echo $data['alamat'];?></textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="border-top">
                                    <div class="card-body">
                                        <input type="submit" name="simpan" class="btn btn-primary" value="Save">
                                         <a href="v_mekanik.php" class="btn btn-danger">Cancel</a>
                                    </div>
                                </div>
                            </form>
                        </div>
