              ...
              <form class="form-horizontal" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="text" name="hrg_beli" id="hrg_beli" class="form-control" id="fname" placeholder="Harga Beli" readonly>
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    <label for="fname" class="col-sm-3 text-right control-label col-form-label">Jumlah Beli</label>
                    <div class="col-sm-4">
                      <input type="text" name="jml_beli" id="jml_beli" class="form-control" id="fname" placeholder="Jumlah Beli" onchange="jumhar();" onkeypress="return isNumberKey(event)">
                    </div>
                  </div>
                  <div class="form-group row">
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              <center><a href='a_po.php?kd_sukucadang=<?php echo $c['kd_sukucadang']; ?>' class="btn btn-danger btn-xs"><i class="far fa-trash-alt"></i></a></center>
                            </td>
                          </tr>
                        <?php $no++;
                        } ?>
