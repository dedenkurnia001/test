...
$sql="select * from sukucadang where kd_sukucadang='$kd_sukucadang'";
...
$nm_sukucadang=$_POST['nm_sukucadang'];
$jenis=$_POST['jenis'];
$satuan=$_POST['satuan'];
$hrg_jual=$_POST['hrg_jual'];
$hrg_beli=$_POST['hrg_beli'];
$stok=$_POST['stok'];
    if (empty($kd_sukucadang) or empty($nm_sukucadang) or empty($jenis) or empty($satuan) or empty($hrg_jual) or empty($hrg_beli) or empty($stok)){
...
alert('Harga Beli tidak boleh melebihi Harga Jual');
    ...
    $a="update sukucadang set nm_sukucadang='$nm_sukucadang', jenis='$jenis', satuan='$satuan', hrg_jual='$hrg_jual', hrg_beli='$hrg_beli', stok='$stok' where kd_sukucadang='$kd_sukucadang'";
    $b=mysqli_query($koneksi,$a);
      if ($b) {
        echo "<script language='javascript'>
        alert('Suku Cadang has been edited');
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Edit Data Suku Cadang</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Data Master</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Suku Cadang</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Edit Data Suku Cadang</h4>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Kode Suku Cadang</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="kd_sukucadang" class="form-control" id="fname" placeholder="Kode Suku Cadang" value="<?php echo $data['kd_sukucadang'];?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nama Suku Cadang</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="nm_sukucadang" class="form-control" id="fname" placeholder="Nama Suku Cadang" value="<?php echo $data['nm_sukucadang'];?>" onkeypress="return huruf(event)">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Jenis</label>
                                        <div class="col-sm-4">
                                            <select name="jenis" class="input-sm input-s form-control">
                                            <option value="">Pilih</option>
                                            <option value="Ban" <?php if ($data['jenis']=="Ban"){echo "selected";}?> >Ban</option>
                                            <option value="Aki" <?php if ($data['jenis']=="Aki"){echo "selected";}?> >Aki</option>
                                            <option value="Rem" <?php if ($data['jenis']=="Rem"){echo "selected";}?> >Rem</option>
                                            <option value="Oli" <?php if ($data['jenis']=="Oli"){echo "selected";}?> >Oli</option>
                                            <option value="Dll" <?php if ($data['jenis']=="Dll"){echo "selected";}?> >Dll</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="satuan" value="<?php echo $data['satuan'];?>" class="form-control" id="fname" placeholder="Satuan">
                                        </div>
                                    </div>
                                     <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Harga Jual</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="hrg_jual" class="form-control" id="fname" placeholder="Harga Jual" value="<?php echo $data['hrg_jual'];?>" onkeypress="return isNumberKey(event)">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Harga Beli</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="hrg_beli" class="form-control" id="fname" placeholder="Ukuran" value="<?php echo $data['hrg_beli'];?>" onkeypress="return isNumberKey(event)">
                                        </div>
                                    </div> 
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Stok</label>
                                        <div class="col-sm-4">
                                            <input type="text" value="<?php echo $data['stok'];?>" name="stok" class="form-control" id="fname" placeholder="Stok" onkeypress="return isNumberKey(event)">
                                        </div>
                                    </div>
                                ...
                                <div class="border-top">
                                    <div class="card-body">
                                        <input type="submit" name="simpan" class="btn btn-primary" value="Save">
                                         <a href="v_sukucadang.php" class="btn btn-danger">Cancel</a>
                                    </div>
                                </div>
                            </form>
                        </div>
