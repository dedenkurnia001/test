...
alert('Data belum lengkap !');
    ...
    $a="update supplier set nm_supplier='$nm_supplier', no_telpon='$no_telpon', alamat='$alamat', email='$email' where id_supplier='$id_supplier'";
                        ...
                        <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="id_supplier" class="form-control" id="fname" placeholder="Id Supplier" value="<?php echo $data['id_supplier'];?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nama Supplier</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="nm_supplier" class="form-control" id="fname" placeholder="Nama Supplier" value="<?php echo $data['nm_supplier'];?>" onkeypress="return huruf(event)">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="email" value="<?php echo $data['email'];?>" class="form-control" id="fname" placeholder="Email" onkeypress="return isNumberKey(event)">
                                        </div>
                                    </div>
                                     <div class="form-group row">
