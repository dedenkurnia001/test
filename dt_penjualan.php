...
$sql="select * from penjualan a, pelanggan b where a.no_penjualan='$no_penjualan' and a.id_pelanggan = b.id_pelanggan";
...
if(isset($_POST['batal'])){
        ...
        document.location='v_penjualan.php';
        </script>";
      }
?>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Detail Data Penjualan</h4>
                        ...
                        <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">No. Penjualan</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control"  placeholder="No. Penjualan" value="<?php echo $data['no_penjualan'];?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    ?>
                                    <?php
                                      $a="select * from dtl_penjualan a, barang b where a.kd_barang = b.kd_barang and a.no_penjualan = '$no_penjualan' order by a.kd_barang";
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <?php $jumhar = $c['hrg_jual'] * $c['jml_beli'];?>
