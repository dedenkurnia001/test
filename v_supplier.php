            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">View Data Supplier</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <a class="btn btn-success" href="a_supplier.php">Tambah Data</a>
                                ...
                                <div class="table-responsive">
                                    ...
                                    ?>
                                    <?php
                                      $a="select * from supplier order by id_supplier";
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><a href="e_supplier.php?id_supplier=<?php echo $c['id_supplier'];?>"><i class="fas fa-edit"></i></a>&nbsp;
                                                
                                                <a href="javascript:if(confirm('Are you sure to delete this data?'))
                                                {document.location='d_supplier.php?id_supplier=<?php echo $c['id_supplier']; ?>';}">
