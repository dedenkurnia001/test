            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">View Data Servis</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <a class="btn btn-success" href="a_servis.php">Tambah Data</a>
                                ...
                                <div class="table-responsive">
                                    ...
                                    ?>
                                    <?php
                                      $a="select * from servis order by kd_servis";
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><a href="e_servis.php?kd_servis=<?php echo $c['kd_servis'];?>"><i class="fas fa-edit"></i></a>&nbsp;
                                                
                                                <a href="javascript:if(confirm('Are you sure to delete this data?'))
                                                {document.location='d_servis.php?kd_servis=<?php echo $c['kd_servis']; ?>';}">
