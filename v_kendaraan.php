            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">View Data Kendaraan</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <a class="btn btn-success" href="a_kendaraan.php">Tambah Data</a>
                                ...
                                <div class="table-responsive">
                                    ...
                                    ?>
                                    <?php
                                      $a="select a.no_polisi, a.id_pelanggan, b.nm_pelanggan, a.merek, a.tipe,
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?php echo $c['no_rangka'];?></td>
                                                <td><?php echo $c['warna'];?></td>
                                                <td><a href="e_kendaraan.php?no_polisi=<?php echo $c['no_polisi'];?>"><i class="fas fa-edit"></i></a>&nbsp;
                                                
                                                <a href="javascript:if(confirm('Are you sure to delete this data?'))
                                                {document.location='d_kendaraan.php?no_polisi=<?php echo $c['no_polisi']; ?>';}">
