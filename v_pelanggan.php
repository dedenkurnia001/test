            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">View Data Pelanggan</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <a class="btn btn-success" href="a_pelanggan.php">Tambah Data</a>
                                ...
                                <div class="table-responsive">
                                    ...
                                    ?>
                                    <?php
                                      $a="select * from pelanggan order by id_pelanggan";
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><a href="e_pelanggan.php?id_pelanggan=<?php echo $c['id_pelanggan'];?>"><i class="fas fa-edit"></i></a>&nbsp;
                                                
                                                <a href="javascript:if(confirm('Are you sure to delete this data?'))
                                                {document.location='d_pelanggan.php?id_pelanggan=<?php echo $c['id_pelanggan']; ?>';}">
