...
$sql="select a.no_polisi, a.id_pelanggan, b.nm_pelanggan, b.jenkel, b.no_telpon, b.alamat, a.merek, a.tipe,
a.no_rangka, a.warna from kendaraan a, pelanggan b
where a.id_pelanggan = b.id_pelanggan and no_polisi='$no_polisi' ";
...
// </script>";
    ...
    $a="update kendaraan set merek='$merek', tipe='$tipe', no_rangka='$no_rangka', warna='$warna' where no_polisi='$no_polisi'";
    $b=mysqli_query($koneksi,$a);
      if ($b) {
        echo "<script language='javascript'>
        alert('Kendaraan has been edited');
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Edit Data Kendaraan</h4>
                        ...
                        <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="id_pelanggan" class="form-control" id="id_pelanggan" placeholder="Id Pelanggan" value="<?php echo $data['id_pelanggan'];?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nama Pelanggan</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="nm_pelanggan" class="form-control" id="nm_pelanggan" placeholder="Nama Pelanggan" value="<?php echo $data['nm_pelanggan'];?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Jenis Kelamin</label>
                                        <div class="col-sm-4">
                                        <input type="text" name="nm_pelanggan" class="form-control" id="jenkel" placeholder="Jenis Kelamin" value="<?php echo $data['jenkel'];?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">No. Telpon</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="no_telpon" class="form-control" id="no_telpon" placeholder="No. Telpon" value="<?php echo $data['no_telpon'];?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Alamat</label>
                                        <div class="col-sm-9">
                                           <textarea rows="4" name="alamat" class="form-control no-resize" id="alamat" placeholder="Alamat" readonly><?php echo $data['alamat'];?></textarea>
                                        </div>
                                    </div>   
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">No. Polisi</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="no_polisi" class="form-control" id="fname" placeholder="No. Polisi" value="<?php echo $data['no_polisi'];?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                           <select class="input-sm input-s form-control" name="merek" >
                                                ...
                                                <option value="Honda" <?php if ($data['merek']=="Honda"){echo "selected";}?> >Honda</option>
                                                <option value="Yamaha" <?php if ($data['merek']=="Yamaha"){echo "selected";}?> >Yamaha</option>
                                                <option value="Suzuki" <?php if ($data['merek']=="Suzuki"){echo "selected";}?> >Suzuki</option>
                                                <option value="Dll" <?php if ($data['merek']=="Dll"){echo "selected";}?> >Dll</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                           <select class="input-sm input-s form-control" name="tipe" >
                                                <option value="">Pilih</option> 
                                                <option value="Vario" <?php if ($data['tipe']=="Vario"){echo "selected";}?> >Vario</option>
                                                <option value="Supra X" <?php if ($data['tipe']=="Supra X"){echo "selected";}?> >Supra X</option>
                                                <option value="Blade" <?php if ($data['tipe']=="Blade"){echo "selected";}?> >Blade</option>
                                                <option value="Scoopy" <?php if ($data['tipe']=="Scoopy"){echo "selected";}?> >Scoopy</option>
                                                <option value="Revo" <?php if ($data['tipe']=="Revo"){echo "selected";}?> >Revo</option>
                                                <option value="Mio" <?php if ($data['tipe']=="Mio"){echo "selected";}?> >Mio</option>
                                                <option value="NMax" <?php if ($data['tipe']=="NMax"){echo "selected";}?> >NMax</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="no_rangka" class="form-control" id="fname" placeholder="No. Rangka" value="<?php echo $data['no_rangka'];?>" >
                                        </div>
                                    </div>
                                     <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Warna</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="warna" class="form-control" id="fname" placeholder="Warna" value="<?php echo $data['warna'];?>" >
                                        </div>
                                    </div>
