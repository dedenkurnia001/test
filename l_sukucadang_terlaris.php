...
if(isset($_POST['cetak'])){
  ...
  $simpan = mysqli_query($koneksi,"select b.kd_sukucadang, sum(jml_jual) as total, e.nm_sukucadang
  ...
  if ($simpan) {
    echo "<script>alert('Laporan 5 Suku Cadang Terlaris Berhasil di Cetak!');window.location='c_l_sukucadang_terlaris.php?periode_awal=$periode_awal&&periode_akhir=$periode_akhir';</script>";
  } else {
    echo "<script>alert('Laporan 5 Suku Cadang Terlaris Gagal di Cetak!');window.location='l_sukucadang_terlaris.php';</script>";
  }
}
?>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">View Data 5 Suku Cadang Terlaris</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Data Laporan</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Lap. 5 Suku Cadang Terlaris</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Laporan Data 5 Suku Cadang Terlaris</h4>
