...
alert('Harga Beli tidak boleh melebihi Harga Jual');
    ...
    $a="insert into sukucadang values('$kd_sukucadang','$nm_sukucadang','$jenis','$hrg_jual','$hrg_beli','$stok','$satuan')";
    $b=mysqli_query($koneksi,$a);
      if ($b) {
        echo "<script language='javascript'>
        alert('Suku Cadang has been saved');
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Add Data Suku Cadang</h4>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Entry Data Suku Cadang</h4>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Kode Suku Cadang</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="kd_sukucadang" class="form-control" id="fname" placeholder="Kode Suku Cadang" value="<?=autonumber("sukucadang","kd_sukucadang",3,"SC")?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nama Suku Cadang</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="nm_sukucadang" class="form-control" id="fname" placeholder="Nama Suku Cadang" onkeypress="return huruf(event)">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Jenis</label>
                                        <div class="col-sm-4">
                                           <select class="input-sm input-s form-control" name="jenis" >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="satuan" class="form-control" id="fname" placeholder="Satuan">
                                        </div>
                                    </div>
                                     <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Harga Jual</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="hrg_jual" class="form-control" id="fname" placeholder="Harga Jual" onkeypress="return isNumberKey(event)">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Harga Beli</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="hrg_beli" class="form-control" id="fname" placeholder="Harga Beli" onkeypress="return isNumberKey(event)">
                                        </div>
                                    </div> 
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Stok</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="stok" class="form-control" id="fname" placeholder="Stok" onkeypress="return isNumberKey(event)">
                                        </div>
                                    </div>
