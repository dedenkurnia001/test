  ...
  <div class='row'>
    <div class='col-lg-12'>
      <h3 class="page-header">
        <a class="btn btn-defaul" href="v_po.php">Kembali</a>
...
<div>
  ...
  include 'koneksi.php';
  $kd_po = $_GET['kd_po'];
  $sql="select a.kd_po, a.tgl_po, a.id_supplier, c.nm_supplier, c.no_telpon, c.alamat, b.kd_sukucadang, e.nm_sukucadang, b.hrg_beli, b.jml_beli, b.hrg_beli * b.jml_beli as jumhar
...
<span style='font-size:14pt'><b>PO : <?php echo $data['kd_po'];?></b></span></br>
BENGKEL HORAS MOTOR</br>
Jl. Anggrek Rosliana 3 No. 3, Slipi, Palmerah, Jakarta Barat</br>
Telp : 021-7426611
</td>
<td style='vertical-align:top' width='30%' align='left'>
<b><span style='font-size:16pt'>Jakarta Barat, <?php echo $data['tgl_po'];?></span></b></br>
...
<td style='text-align:right'>Rp0,00</td></tr>
 ...
 <table width="100%" border="1" cellspacing="0">
  ...
  $no=1;
  $i= 1;
  $a="select a.kd_po, a.tgl_po, a.id_supplier, c.nm_supplier, c.no_telpon, c.alamat, b.kd_sukucadang, e.nm_sukucadang, b.hrg_beli, b.jml_beli, b.hrg_beli * b.jml_beli as jumhar
        from po a, dtl_po b, supplier c, sukucadang e
        where a.kd_po = b.kd_po and a.id_supplier = c.id_supplier and b.kd_sukucadang = e.kd_sukucadang and
        a.kd_po = '$kd_po'";
...
function printDiv(elementId) {
    ...
    window.frames["print_frame"].document.title = 'PO';
