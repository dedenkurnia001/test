            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">View Data Cetak PO</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <a class="btn btn-success" href="a_po.php">Tambah Data</a>
                                        ...
                                        <tbody>
                                            ...
                                            $a = "select a.kd_po,
                                             a.tgl_po,
                                              a.id_supplier,
                                               b.nm_supplier
                                                from po a, supplier b 
                                      where a.id_supplier = b.id_supplier order by a.kd_po";
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href="dt_po.php?kd_po=<?php echo $c['kd_po']; ?>"><i class="fas fa-edit"></i></a>
                                                        <a href="javascript:if(confirm('Are you sure to print this data?'))
                                                {document.location='po.php?kd_po=<?php echo $c['kd_po']; ?>';}">
