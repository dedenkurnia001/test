            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">View Data Cetak Nota Penjualan</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <a class="btn btn-success" href="a_nota_penjualan.php">Tambah Data</a>
                                ...
                                <div class="table-responsive">
                                    ...
                                    ?>
                                    <?php
                                      $a="select a.kd_nota, a.tgl_nota, a.id_pelanggan, b.nm_pelanggan, a.jml_biaya from nota_jual a, pelanggan b 
                                      where a.id_pelanggan = b.id_pelanggan order by a.kd_nota";
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?php echo $c['jml_biaya'];?></td>
                                                <td><a  href="dt_nota_penjualan.php?kd_nota=<?php echo $c['kd_nota'];?>"><i class="fas fa-edit"></i></a>
                                                <a href="javascript:if(confirm('Are you sure to print this data?'))
                                                {document.location='nota_penjualan.php?kd_nota=<?php echo $c['kd_nota']; ?>';}">
