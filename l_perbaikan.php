...
if(isset($_POST['cetak'])){
  ...
  $simpan = mysqli_query($koneksi,"select a.kd_perbaikan, a.tgl_perbaikan, b.id_pelanggan, c.nm_pelanggan, a.no_polisi, b.merek, d.nm_mekanik
  ...
  if ($simpan) {
    echo "<script>alert('Laporan Perbaikan Berhasil di Cetak!');window.location='c_l_perbaikan.php?periode_awal=$periode_awal&&periode_akhir=$periode_akhir';</script>";
  } else {
    echo "<script>alert('Laporan Perbaikan Gagal di Cetak!');window.location='l_perbaikan.php';</script>";
  }
}
?>
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Lap. Perbaikan</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Laporan Data Perbaikan</h4>
