...
mysqli_query($koneksi,"DELETE FROM temp_dtl_sukucadang WHERE kd_sukucadang='$kd_sukucadang'");

$kd_servis = $_GET['kd_servis'];
mysqli_query($koneksi,"DELETE FROM temp_dtl_servis WHERE kd_servis='$kd_servis'");

if(isset($_POST['batal'])){
    $a="delete from temp_dtl_sukucadang";
    $c="delete from temp_dtl_servis";
    $b=mysqli_query($koneksi,$a);
    $d=mysqli_query($koneksi,$c);
      if ($b) {
        echo "<script language='javascript'>
        document.location='v_perbaikan.php';
        </script>";
      }
    }

if(isset($_POST['tambah'])){
$kd_perbaikan=$_POST['kd_perbaikan'];
$kd_sukucadang=$_POST['kd_sukucadang'];
$hrg_jual=$_POST['hrg_jual'];
$jml_jual=$_POST['jml_jual'];
$stok=$_POST['stok'];
$cek  = "SELECT * FROM temp_dtl_sukucadang where kd_sukucadang = '$kd_sukucadang'";
...
alert('Data barang sudah ada di list');
    ...
    $a="insert into temp_dtl_sukucadang values('$kd_perbaikan','$kd_sukucadang','$hrg_jual','$jml_jual')";
    $b=mysqli_query($koneksi,$a);
      if ($b) {
        echo "<script language='javascript'>
        document.location='a_perbaikan.php';
        </script>";
      }
    }
  }
  ...
  if(isset($_POST['tambah_servis'])){
    $kd_perbaikan=$_POST['kd_perbaikan'];
    $kd_servis=$_POST['kd_servis'];
    $harga=$_POST['harga'];
    $cek  = "SELECT * FROM temp_dtl_servis where kd_servis = '$kd_servis'";
    $cek2 = mysqli_query($koneksi,$cek);
    $cek3 = mysqli_num_rows($cek2);
          
        if (empty($kd_servis) or empty($harga)){
          echo "<script language='javascript'>
    alert('Data belum lengkap !');
    </script>";
    ...
    alert('Data barang sudah ada di list');
        ...
        $a="insert into temp_dtl_servis values('$kd_perbaikan','$kd_servis','$harga')";
        $b=mysqli_query($koneksi,$a);
          if ($b) {
            echo "<script language='javascript'>
            document.location='a_perbaikan.php';
...
$date = str_replace('/', '-', $tgl_perbaikan);
$tgl_perbaikan2= date('Y-m-d', strtotime($date));
$no_polisi=$_POST['no_polisi'];
$id_mekanik=$_POST['id_mekanik'];
    if (empty($kd_perbaikan) or empty($tgl_perbaikan) or empty($no_polisi) or empty($id_mekanik)){
      echo "<script language='javascript'>
alert('Data belum lengkap !');
</script>";
    }else{
    $a="insert into perbaikan values('$kd_perbaikan','$tgl_perbaikan2','$id_mekanik','$no_polisi')";
    $b=mysqli_query($koneksi,$a);
      if ($a) {
    $simdet  = mysqli_query($koneksi,"SELECT * FROM temp_dtl_sukucadang");
    while ($r=mysqli_fetch_row($simdet)) {
      mysqli_query($koneksi,"UPDATE sukucadang set stok = stok - $r[3] where kd_sukucadang = '$r[1]'");
      mysqli_query($koneksi,"INSERT INTO dtl_sukucadang VALUES ('$kd_perbaikan','$r[1]','$r[3]','$r[2]')");

    }
    $simdet2  = mysqli_query($koneksi,"SELECT * FROM temp_dtl_servis");
    while ($rr=mysqli_fetch_row($simdet2)) {
      mysqli_query($koneksi,"INSERT INTO dtl_servis VALUES ('$kd_perbaikan','$rr[1]','$rr[2]')");

    }
    mysqli_query($koneksi,"TRUNCATE TABLE temp_dtl_sukucadang");
    mysqli_query($koneksi,"TRUNCATE TABLE temp_dtl_servis");
    echo "<script language='javascript'>
    alert('Perbaikan has been saved');
    document.location='v_perbaikan.php';
    </script>";   
      }
    }
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Add Perbaikan</h4>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    ?>
                                    <?php
                                      $a="select * from temp_dtl_sukucadang a, sukucadang b where a.kd_sukucadang = b.kd_sukucadang order by a.kd_sukucadang";
                                      $b=mysqli_query($koneksi,$a);
                                      $no=1;
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><center><a href='a_perbaikan.php?kd_sukucadang=<?php echo $c['kd_sukucadang']; ?>' class="btn btn-danger btn-xs"><i class="far fa-trash-alt"></i></a></center>
                                                </td>
                                            </tr>
                                    <?php $no++; } ?>
                                        </tbody>
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Kode Servis</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="kd_servis" id="kd_servis" class="form-control" id="fname" placeholder="Kode Servis" readonly>
                                        </div><button type="button" class="btn btn-warning" data-toggle="modal" data-target="#myModal2" >Cari</button>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nama Servis</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="nm_servis" id="nm_servis" class="form-control" id="fname" placeholder="Nama Servis" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Harga</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="harga" id="harga" class="form-control" id="fname" placeholder="Harga" readonly>
                                        </div><input type="submit" name="tambah_servis" value="Tambah" class="btn btn-success">
                                    </div>
                                    <div class="table-responsive">
                                    ...
                                    ?>
                                    <?php
                                      $a="select * from temp_dtl_servis a, servis b where a.kd_servis = b.kd_servis order by a.kd_servis";
                                      $b=mysqli_query($koneksi,$a);
                                      $no=1;
                                      while($c=mysqli_fetch_array($b)){
                                    ?>
                                            <tr>
                                                ...
                                                <td><center><a href='a_perbaikan.php?kd_servis=<?php echo $c['kd_servis']; ?>' class="btn btn-danger btn-xs"><i class="far fa-trash-alt"></i></a></center>
                                                </td>
                                            </tr>
                                    <?php $no++; } ?>
                                        </tbody>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="kd_perbaikan" class="form-control" id="fname" placeholder="Kode Perbaikan" value="<?=autonumber("perbaikan","kd_perbaikan",7,"PRBKN")?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Tanggal Perbaikan</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="tgl_perbaikan" class="form-control" id="datepicker-autoclose" placeholder="dd/mm/yyyy">
                                        </div>
                                    </div>
                                  <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Id Pelanggan</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="id_pelanggan" id="id_pelanggan" class="form-control"  placeholder="Id Pelanggan" readonly>
                                  ...
                                  <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="nm_pelanggan" id="nm_pelanggan" class="form-control" placeholder="Nama Pelanggan" readonly>
                                        </div>
                                    </div>
                                  <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">No. Polisi</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="no_polisi" id="no_polisi" class="form-control" placeholder="No. Polisi" readonly>
                                        </div>
                                    </div>
                                  <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Merek</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="merek" id="merek" class="form-control" placeholder="Merek" readonly>
                                        </div>
                                    </div>
                                  <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Tipe</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="tipe" id="tipe" class="form-control" placeholder="Tipe" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Id Mekanik</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="id_mekanik" id="id_mekanik" class="form-control"  placeholder="Id Mekanik" readonly>
                                        </div><button type="button" class="btn btn-warning" data-toggle="modal" data-target="#myModal3" >Cari</button>
                                    </div>
                                  <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nama Mekanik</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="nm_mekanik" id="nm_mekanik" class="form-control" placeholder="Nama Mekanik" readonly>
                                        </div>
                                    </div>
                                  <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                        <?php
                                          $a="select coalesce(null,sum(hrg_jual * jml_jual),0) as total from temp_dtl_sukucadang";
                                          $b=mysqli_query($koneksi,$a);
                                          $c=mysqli_fetch_array($b);

                                          $d="select coalesce(null,sum(hrg_servis),0) as total_2 from temp_dtl_servis";
                                          $e=mysqli_query($koneksi,$d);
                                          $f=mysqli_fetch_array($e);

                                          $grand_total = $c['total_1'] + $f['total_2']
                                        ?>
