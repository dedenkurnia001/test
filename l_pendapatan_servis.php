...
if(isset($_POST['cetak'])){
  ...
  $simpan = mysqli_query($koneksi,"select a.kd_perbaikan, a.tgl_perbaikan, a.no_polisi, d.nm_pelanggan, b.hrg_servis
  ...
  if ($simpan) {
    echo "<script>alert('Laporan Pendapatan Jasa Servis Berhasil di Cetak!');window.location='c_l_pendapatan_servis.php?periode_awal=$periode_awal&&periode_akhir=$periode_akhir';</script>";
  } else {
    echo "<script>alert('Laporan Pendapatan Jasa Servis Gagal di Cetak!');window.location='l_pendapatan_servis.php';</script>";
  }
}
?>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">View Data Pendapatan Jasa Servis</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Data Laporan</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Lap. Pendapatan Jasa Servis</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Laporan Data Pendapatan Jasa Servis</h4>
