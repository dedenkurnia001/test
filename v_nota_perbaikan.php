            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">View Data Cetak Nota Perbaikan</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <a class="btn btn-success" href="a_nota_perbaikan.php">Tambah Data</a>
                                ...
                                <div class="table-responsive">
                                    ...
                                    ?>
                                    <?php
                                      $a="select f.kd_nota, f.tgl_nota, a.kd_perbaikan, a.tgl_perbaikan, e.id_pelanggan, b.nm_pelanggan, a.id_mekanik, c.nm_mekanik
                                      from perbaikan a, pelanggan b, mekanik c, kendaraan e, nota_perbaikan f where a.kd_perbaikan = f.kd_perbaikan and a.id_mekanik = c.id_mekanik 
                                    ...
                                    ?>
                                            <tr>
                                                <td><?php echo $no;?></td>
                                                <td><?php echo $c['kd_nota'];?></td>
                                                <td><?php echo $c['tgl_nota'];?></td>
                                                <td><?php echo $c['kd_perbaikan'];?></td>
                                                <td><?php echo $c['tgl_perbaikan'];?></td>
                                                <td><?php echo $c['id_pelanggan'];?></td>
                                                <td><?php echo $c['nm_pelanggan'];?></td>
                                                <td><a href="dt_nota_perbaikan.php?kd_perbaikan=<?php echo $c['kd_perbaikan'];?>"><i class="fas fa-edit"></i></a>
                                                <a href="javascript:if(confirm('Are you sure to print this data?'))
                                                {document.location='nota_perbaikan.php?kd_nota=<?php echo $c['kd_nota']; ?>';}">
