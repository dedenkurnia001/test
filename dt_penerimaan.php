...
<?php
include "koneksi.php";
if(isset($_GET['kd_ttb'])){
$kd_ttb=$_GET['kd_ttb'];
$sql="select * from ttb a, po b, supplier c where a.kd_ttb = '$kd_ttb' and a.kd_po = b.kd_po and b.id_supplier = c.id_supplier";
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Detail Cetak Penerimaan</h4>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Detail Data Cetak Penerimaan</h4>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Kode Penerimaan</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control"  placeholder="Kode Penerimaan" value="<?php echo $data['kd_ttb'];?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Tanggal Penerimaan</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control"  placeholder="Tanggal Penerimaan" value="<?php echo $data['tgl_ttb'];?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">No. Reff Kwt</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control"  placeholder="No. Reff Kwt" value="<?php echo $data['no_reffkwt'];?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Kode PO</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control"  placeholder="Kode PO" value="<?php echo $data['kd_po'];?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Tanggal PO</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control"  placeholder="Tanggal PO" value="<?php echo $data['tgl_po'];?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                          <?php
                                          $kd_ttb=$_GET['kd_ttb']; 
                                          $total_ttb="select sum(hrg_beli * jml_terima) as total from isi a where a.kd_ttb = '$kd_ttb'";
                                          $exec_total_ttb=mysqli_query($koneksi,$total_ttb);
                                          $data_total_ttb=mysqli_fetch_array($exec_total_ttb);
                                          ?>
                                            <input type="text" class="form-control" value="<?php echo $data_total_ttb['total'];?>" placeholder="Total Harga" readonly>
                                        </div>
                                    </div>
                                    ...
                                    ?>
                                    <?php
                                      $a="select * from isi a, sukucadang b where a.kd_sukucadang = b.kd_sukucadang and a.kd_ttb = '$kd_ttb' order by a.kd_sukucadang";
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <?php $jumhar = $c['hrg_beli'] * $c['jml_terima'];?>
