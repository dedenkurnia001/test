...
$stok=$_POST['stok'];
    if (empty($kd_barang) or empty($nm_barang) or empty($satuan) or empty($ukuran) or empty($hrg_jual) or empty($hrg_beli) or empty($stok)){
...
alert('Harga Beli tidak boleh melebihi Harga Jual');
    ...
    $a="insert into barang values('$kd_barang','$nm_barang','$satuan','$ukuran','$hrg_jual','$hrg_beli','$stok')";
    $b=mysqli_query($koneksi,$a);
      if ($b) {
        echo "<script language='javascript'>
        alert('Barang has been saved');
        </script>";
      }
    }
  }
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">View Data Suku Cadang</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Data Laporan</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Lap. Suku Cadang</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <a class="btn btn-success" href="c_l_sukucadang.php">Cetak</a>
