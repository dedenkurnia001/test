...
$sql="select * from servis where kd_servis='$kd_servis'";
...
$harga=$_POST['harga'];
    if (empty($kd_servis) or empty($nm_servis) or empty($harga) ){
      echo "<script language='javascript'>
alert('Data belum lengkap !');
</script>";
    }else{
    $a="update servis set nm_servis='$nm_servis', harga='$harga' where kd_servis='$kd_servis'";
    $b=mysqli_query($koneksi,$a);
      if ($b) {
        echo "<script language='javascript'>
        alert('Servis has been edited');
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Edit Data Servis</h4>
                        ...
                        <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="kd_servis" class="form-control" id="fname" placeholder="Kode Servis" value="<?php echo $data['kd_servis'];?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nama Servis</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="nm_servis" class="form-control" id="fname" placeholder="Nama Servis" value="<?php echo $data['nm_servis'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Harga</label>
                                        <div class="col-sm-4">
                                            <input type="text" maxlength="13" name="harga" value="<?php echo $data['harga'];?>" class="form-control" id="fname" placeholder="Harga" onkeypress="return isNumberKey(event)">
                                        </div>
                                    </div>
                                ...
                                <div class="border-top">
                                    <div class="card-body">
                                        <input type="submit" name="simpan" class="btn btn-primary" value="Save">
                                         <a href="v_servis.php" class="btn btn-danger">Cancel</a>
                                    </div>
                                </div>
                            </form>
                        </div>
