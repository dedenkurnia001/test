...
$tgl_nota2= date('Y-m-d', strtotime($date));
    if (empty($kd_nota) or empty($kd_perbaikan)){
      echo "<script language='javascript'>
alert('Data belum lengkap !');
</script>";
    }else{
    $a="insert into nota_perbaikan values('$kd_nota','$tgl_nota2','$kd_perbaikan')";
    $b=mysqli_query($koneksi,$a);
    echo "<script language='javascript'>
    alert('Cetak Nota Perbaikan has been saved');
    document.location='v_nota_perbaikan.php';
    </script>";   
      }
    }
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Add Cetak Nota Perbaikan</h4>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Cetak Nota Perbaikan</h4>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Kode Nota Perbaikan</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="kd_nota" class="form-control" placeholder="Kode Nota Perbaikan" readonly value="<?=autonumber("nota_perbaikan","kd_nota",7,"NTP")?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Tanggal Nota Perbaikan</label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="kd_perbaikan" id="kd_perbaikan" class="form-control" id="fname" placeholder="Kode Perbaikan" readonly>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="tgl_perbaikan" id="tgl_perbaikan" class="form-control" id="fname" placeholder="Tanggal Perbaikan" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h5 class="modal-title" id="exampleModalLabel">Pilih Perbaikan</h5>
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          ...
                          <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                              <?php
                              $get = mysqli_query($koneksi,"select a.kd_perbaikan, a.tgl_perbaikan, e.id_pelanggan, b.nm_pelanggan, a.no_polisi, e.merek, e.tipe, a.id_mekanik, c.nm_mekanik
                              from perbaikan a, pelanggan b, mekanik c, kendaraan e where a.id_mekanik = c.id_mekanik 
                              and a.no_polisi = e.no_polisi and e.id_pelanggan = b.id_pelanggan 
                              and  a.kd_perbaikan not in(select kd_perbaikan from nota_perbaikan)
                              order by a.kd_perbaikan desc");
                              while ($tampil=mysqli_fetch_array($get)) {
                              ?>
                              <tr>
                                <td id='kd_perbaikan_<?php echo $tampil['kd_perbaikan'];?>'><?php echo $tampil['kd_perbaikan']; ?></td>
                                <td id='tgl_perbaikan_<?php echo $tampil['kd_perbaikan'];?>'><?php echo $tampil['tgl_perbaikan']; ?></td>
                                <td id='id_pelanggan_<?php echo $tampil['kd_perbaikan'];?>'><?php echo $tampil['id_pelanggan']; ?></td>
                                <td id='nm_pelanggan_<?php echo $tampil['kd_perbaikan'];?>'><?php echo $tampil['nm_pelanggan']; ?></td>
                                <td id='no_polisi_<?php echo $tampil['kd_perbaikan'];?>'><?php echo $tampil['no_polisi']; ?></td>
                                <td id='merek_<?php echo $tampil['kd_perbaikan'];?>'><?php echo $tampil['merek']; ?></td>
                                <td id='tipe_<?php echo $tampil['kd_perbaikan'];?>'><?php echo $tampil['tipe']; ?></td>
                                <td id='id_mekanik_<?php echo $tampil['kd_perbaikan'];?>'><?php echo $tampil['id_mekanik']; ?></td>
                                <td id='nm_mekanik_<?php echo $tampil['kd_perbaikan'];?>'><?php echo $tampil['nm_mekanik']; ?></td>
                                <td><button onclick="pilihPerbaikan('<?php echo $tampil['kd_perbaikan']; ?>')" class="btn btn-info btn-xs"><i class="fas fa-plus"></i></button></td>
                              </tr>
                              <?php } ?>
    ...
    function pilihPerbaikan(kd_perbaikan)
    {
        kd_perbaikan = $('#kd_perbaikan_'+kd_perbaikan).html();
        tgl_perbaikan     = $('#tgl_perbaikan_'+kd_perbaikan).html();
        id_pelanggan     = $('#id_pelanggan_'+kd_perbaikan).html();
        nm_pelanggan     = $('#nm_pelanggan_'+kd_perbaikan).html();
        no_polisi     = $('#no_polisi_'+kd_perbaikan).html();
        merek     = $('#merek_'+kd_perbaikan).html();
        tipe     = $('#tipe_'+kd_perbaikan).html();
        id_mekanik     = $('#id_mekanik_'+kd_perbaikan).html();
        nm_mekanik     = $('#nm_mekanik_'+kd_perbaikan).html();
        $('#kd_perbaikan').val(kd_perbaikan);
        $('#tgl_perbaikan').val(tgl_perbaikan);
