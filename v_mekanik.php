            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">View Data Mekanik</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <a class="btn btn-success" href="a_mekanik.php">Tambah Data</a>
                                ...
                                <div class="table-responsive">
                                    ...
                                    ?>
                                    <?php
                                      $a="select * from mekanik order by id_mekanik";
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                ?></td>
                                                <td><?php echo $c['no_telpon'];?></td>
                                                <td><?php echo $c['alamat'];?></td>
                                                <td><a href="e_mekanik.php?id_mekanik=<?php echo $c['id_mekanik'];?>"><i class="fas fa-edit"></i></a>&nbsp;
                                                
                                                <a href="javascript:if(confirm('Are you sure to delete this data?'))
                                                {document.location='d_mekanik.php?id_mekanik=<?php echo $c['id_mekanik']; ?>';}">
