...
alert('Data belum lengkap !');
    ...
    $a="insert into mekanik values('$id_mekanik','$nm_mekanik','$jenkel','$no_telpon','$alamat')";
    $b=mysqli_query($koneksi,$a);
      if ($b) {
        echo "<script language='javascript'>
        alert('Mekanik has been saved');
                            ...
                            <form class="form-horizontal" method="post">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="id_mekanik" class="form-control" id="fname" placeholder="Id Mekanik" readonly value="<?=autonumber("mekanik","id_mekanik",3,"MK")?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nama Mekanik</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="nm_mekanik" class="form-control" id="fname" placeholder="Nama Mekanik" onkeypress="return huruf(event)">
                                        </div>
                                    </div>
                                    <div class="form-group row">
