...
if(isset($_POST['cetak'])){
  ...
  $simpan = mysqli_query($koneksi,"select a.kd_nota, a.tgl_nota, a.id_pelanggan, c.nm_pelanggan, b.kd_sukucadang, e.nm_sukucadang, b.hrg_jual, b.jml_jual, b.hrg_jual * b.jml_jual as jumhar
  ...
  if ($simpan) {
    echo "<script>alert('Laporan Penjualan Berhasil di Cetak!');window.location='c_l_penjualan.php?periode_awal=$periode_awal&&periode_akhir=$periode_akhir';</script>";
  } else {
    echo "<script>alert('Laporan Penjualan Gagal di Cetak!');window.location='l_penjualan.php';</script>";
  }
}
?>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">View Data Penjualan</h4>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Laporan Data Penjualan</h4>
