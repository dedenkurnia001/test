            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">View Data Perbaikan</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <a class="btn btn-success" href="a_perbaikan.php">Tambah Data</a>
                                ...
                                <div class="table-responsive">
                                    ...
                                    ?>
                                    <?php
                                    //   $a="select a.kd_perbaikan, a.tgl_perbaikan, e.id_pelanggan, b.nm_pelanggan, a.id_mekanik, c.nm_mekanik
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?php echo $c['id_mekanik'];?></td>
                                                <td><?php echo $c['nm_mekanik'];?></td>
                                                <td><center><a class="btn btn-info btn-xs" href="dt_perbaikan.php?kd_perbaikan=<?php echo $c['kd_perbaikan'];?>"><i class="fas fa-edit"></i></a></center>&nbsp;
                                                </td>
                                            </tr>
                                    <?php $no++; } ?>
                                        </tbody>
