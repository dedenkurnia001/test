...
if(isset($_POST['cetak'])){
  ...
  $simpan = mysqli_query($koneksi,"select a.kd_po, a.tgl_po, a.id_supplier, c.nm_supplier, b.kd_sukucadang, e.nm_sukucadang, b.hrg_beli, b.jml_beli, b.hrg_beli * b.jml_beli as jumhar
  ...
  if ($simpan) {
    echo "<script>alert('Laporan Pembelian Berhasil di Cetak!');window.location='c_l_pembelian.php?periode_awal=$periode_awal&&periode_akhir=$periode_akhir';</script>";
  } else {
    echo "<script>alert('Laporan Pembelian Gagal di Cetak!');window.location='l_pembelian.php';</script>";
  }
}
?>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">View Data Pembelian</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Data Laporan</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Lap. Pembelian</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
