...
alert('Data belum lengkap !');
    ...
    $a="insert into pelanggan values('$id_pelanggan','$nm_pelanggan','$jenkel','$no_telpon','$alamat')";
    $b=mysqli_query($koneksi,$a);
      if ($b) {
        echo "<script language='javascript'>
        alert('Pelanggan has been saved');
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Add Data Pelanggan</h4>
                            ...
                            <form class="form-horizontal" method="post">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="id_pelanggan" class="form-control" id="fname" placeholder="Id Pelanggan" readonly value="<?=autonumber("pelanggan","id_pelanggan",3,"P")?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nama Pelanggan</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="nm_pelanggan" class="form-control" id="fname" placeholder="Nama Pelanggan" onkeypress="return huruf(event)">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Jenis Kelamin</label>
                                        <div class="col-sm-4">
                                            <input type="radio" name="jenkel" id="optionsRadios2" value="L">
                                            Laki - laki &nbsp;
