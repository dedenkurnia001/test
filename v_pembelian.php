            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <a class="btn btn-success" href="a_pembelian.php">Tambah Data</a>
                                ...
                                <div class="table-responsive">
                                    ...
                                    ?>
                                    <?php
                                      $a="select * from pembelian a, supplier b where a.id_supplier = b.id_supplier order by a.no_pembelian";
                                    ...
                                    ?>
                                            <tr>
                                                <td><?php echo $no;?></td>
                                                <td><?php echo $c['no_pembelian'];?></td>
                                                <td><?php echo $c['tgl_pembelian'];?></td>
                                                <td><?php echo $c['total_harga'];?></td>
                                                <td><?php echo $c['id_supplier'];?></td>
                                                <td><?php echo $c['nm_supplier'];?></td>
                                                <td><center><a class="btn btn-info btn-xs" href="dt_pembelian.php?no_pembelian=<?php echo $c['no_pembelian'];?>"><i class="fas fa-edit"></i></a></center>&nbsp;
                                                </td>
                                            </tr>
                                    <?php $no++; } ?>
                                        </tbody>
