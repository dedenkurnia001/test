...
$sql="select * from user a, pegawai b where a.id_user='$id_user' and a.id_user = b.id_pegawai";
...
$konfirmasi_password=$_POST['konfirmasi_password'];
    if (empty($password_baru) or empty($konfirmasi_password)){
...
{document.location='home.php';}
        ...
        if($password_baru == $konfirmasi_password){
         $a="select * from user where id_user='$id_user' and password ='$password' ";
         $b=mysqli_query($koneksi,$a);
         if(mysqli_num_rows($b)>0) {      
         $c="update user set password = '$password_baru' where id_user='$id_user'";
                    ...
                    <ul id="sidebarnav" class="p-t-30">
                       ...
                       <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Data Master </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                ...
                                <li class="sidebar-item"><a href="a_pegawai.php" class="sidebar-link"><i class="mdi mdi-note-outline"></i><span class="hide-menu"> Data Pegawai </span></a></li>
                            </ul>
                        </li>
                        ...
                        <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="id_user" class="form-control" id="fname" placeholder="Id User" value="<?php echo $data['id_user'];?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nama</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="nm_pegawai" class="form-control" id="fname" placeholder="Nama" value="<?php echo $data['nm_pegawai'];?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Posisi</label>
                                         <div class="col-sm-4">
                                            <input type="text" name="nm_pegawai" class="form-control" id="fname" placeholder="Nama" value="<?php echo $data['role'];?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Password</label>
                                        <div class="col-sm-4">
                                            <input type="password" name="password" class="form-control" id="fname" placeholder="Password">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Password Baru</label>
                                        <div class="col-sm-4">
                                            <input type="password" name="password_baru" class="form-control" id="fname" placeholder="Password Baru">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Konfirmasi Password</label>
                                        <div class="col-sm-4">
                                            <input type="password" name="konfirmasi_password" class="form-control" id="fname" placeholder="Konfirmasi Password">
                                        </div>
                                    </div>  
                                </div>
