...
if(isset($_GET['kd_po'])){
$kd_po=$_GET['kd_po'];
$sql="select * from po a, supplier b where a.kd_po='$kd_po' and a.id_supplier = b.id_supplier";
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Detail Cetak PO</h4>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Detail Data Cetak PO</h4>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                          <?php
                                          $kd_po=$_GET['kd_po']; 
                                          $total_po="select sum(hrg_beli * jml_beli) as total from dtl_po a where a.kd_po = '$kd_po'";
                                          $exec_total_po=mysqli_query($koneksi,$total_po);
                                          $data_total_po=mysqli_fetch_array($exec_total_po);
                                          ?>
                                            <input type="text" class="form-control" value="<?php echo $data_total_po['total'];?>" placeholder="Total Harga" readonly>
                                        </div>
                                    </div>
