            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <a class="btn btn-success" href="a_sukucadang.php">Tambah Data</a>
                                ...
                                <div class="table-responsive">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><a href="e_sukucadang.php?kd_sukucadang=<?php echo $c['kd_sukucadang'];?>"><i class="fas fa-edit"></i></a>&nbsp;
                                                
                                                <a href="javascript:if(confirm('Are you sure to delete this data?'))
                                                {document.location='d_sukucadang.php?kd_sukucadang=<?php echo $c['kd_sukucadang']; ?>';}">
