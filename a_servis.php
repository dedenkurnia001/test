...
alert('Data belum lengkap !');
    ...
    $a="insert into servis values('$kd_servis','$nm_servis','$harga')";
    $b=mysqli_query($koneksi,$a);
      if ($b) {
        echo "<script language='javascript'>
        alert('Servis has been saved');
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Add Data Servis</h4>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" method="post">
                                <div class="card-body">
                                    <h4 class="card-title">Entry Data Servis</h4>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Kode Servis</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="kd_servis" class="form-control" id="fname" placeholder="Kode Servis" readonly value="<?=autonumber("servis","kd_servis",2,"SVC")?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nama Servis</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="nm_servis" class="form-control" id="fname" placeholder="Nama Servis">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Harga</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="harga" class="form-control" id="fname" placeholder="Harga" onkeypress="return isNumberKey(event)" maxlength="13">
                                        </div>
                                    </div>
                                </div>
